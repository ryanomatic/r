...
void wear(struct char_data *ch, struct obj_data *obj_object, int keyword)
{
    ...
    switch(keyword) {
	case 0: {  /* LIGHT SOURCE */
                        if (ch->equipment[WEAR_LIGHT] && wearall)
                                break;

                        if (ch->equipment[WEAR_LIGHT]) {
                                act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_LIGHT], 0, TO_CHAR);
                                act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_LIGHT], 0, TO_ROOM);
	...
	case 2: {
        ...
        case 3:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_BODY)) {
                                if (ch->equipment[WEAR_BODY] && wearall)
                                        break;

                                if (ch->equipment[WEAR_BODY]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_BODY], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_BODY], 0, TO_ROOM);
        ...
        case 4:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_HEAD)) {
                                if (ch->equipment[WEAR_HEAD] && wearall)
                                        break;

                                if (ch->equipment[WEAR_HEAD]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_HEAD], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_HEAD], 0, TO_ROOM);
        ...
        case 5:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_LEGS)) {
                                if (ch->equipment[WEAR_LEGS] && wearall)
                                        break;

                                if (ch->equipment[WEAR_LEGS]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_LEGS], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_LEGS], 0, TO_ROOM);
        ...
        case 6:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_FEET)) {
                                if (ch->equipment[WEAR_FEET] && wearall)
                                        break;

                                if (ch->equipment[WEAR_FEET]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_FEET], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_FEET], 0, TO_ROOM);
        ...
        case 7:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_HANDS)) {
                                if (ch->equipment[WEAR_HANDS] && wearall)
                                        break;

                                if (ch->equipment[WEAR_HANDS]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_HANDS], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_HANDS], 0, TO_ROOM);
        ...
        case 8:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_ARMS)) {
                                if (ch->equipment[WEAR_ARMS] && wearall)
                                        break;

                                if (ch->equipment[WEAR_ARMS]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_ARMS], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_ARMS], 0, TO_ROOM);
        ...
        case 9:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_ABOUT)) {
                                if (ch->equipment[WEAR_ABOUT] && wearall)
                                        break;

                                if (ch->equipment[WEAR_ABOUT]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_ABOUT], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_ABOUT], 0, TO_ROOM);
        ...
        case 10:{
                        if (CAN_WEAR(obj_object, ITEM_WEAR_WAISTE)) {
                                if (ch->equipment[WEAR_WAISTE] && wearall)
                                        break;

                                if (ch->equipment[WEAR_WAISTE]) {
                                        act("You stop using $p.", FALSE, ch, ch->equipment[WEAR_WAISTE], 0, TO_CHAR);
                                        act("$n stops using $p.", TRUE, ch, ch->equipment[WEAR_WAISTE], 0, TO_ROOM);
	...
	case 12:
        ...
        case 13:
                if (CAN_WEAR(obj_object, ITEM_HOLD)) {
                        if (ch->equipment[HOLD] && wearall)
                                break;

                        if (ch->equipment[HOLD]) {
                                act("You stop using $p.", FALSE, ch, ch->equipment[HOLD], 0, TO_CHAR);
                                act("$n stops using $p.", TRUE, ch, ch->equipment[HOLD], 0, TO_ROOM);
